        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item menu-open">
                <a href="../forms/tampildesa.php" class="nav-link active">
                  <i class="fas fa-caret-right nav-icon"></i>
                  <p>Desa</p>
                </a>
              </li>
                  ...
                  <tbody>
                  	...
                  	if($hasil === false) {
                  		...
                  		while($data = $hasil->fetch_array()){
                  			...
                  			echo "<td><a href=editdesa.php?id_desa=$data[id_desa]>Edit</a> <a href=tampildesa.php?hapus=$data[id_desa]>Hapus</a></td>";
